...
export function LessonIntroPage({
  ...
  return (
    <div className="min-h-screen bg-background">
      <main className="relative mx-auto flex w-full max-w-6xl flex-col px-4 py-5 sm:px-6 md:min-h-screen md:py-section-lg">
        <button
          onClick={handleBack}
          className={cn(
            'absolute flex items-center gap-1 text-muted-foreground hover:text-foreground transition-colors duration-normal cursor-pointer',
            rtl ? 'right-0 top-0' : 'left-0 top-0',
          )}
          aria-label={t('back')}
        >
