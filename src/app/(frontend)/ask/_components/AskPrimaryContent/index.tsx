        ...
        {!currentFile?.mediaId && (
          <div className="flex justify-center mb-10">
            <button
              ...
              className="flex items-center gap-3 px-8 py-4 rounded-2xl font-black bg-primary text-primary-foreground hover:bg-primary/90 transition-all duration-normal shadow-elevation-3 hover:shadow-elevation-4 hover:-translate-y-0.5 group disabled:opacity-50"
            >
              {isUploading ? (
