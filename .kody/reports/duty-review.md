...
|------|-------|---------|---------|------|
| approval-gate | cto | 15m | broken | state file never created (404); kody-job-next-state block present in body but 0 commits to state path |
...
| dev-ci-health | cto | 1d | broken | kody-job-next-state present but missing lastRunISO/nextEligibleISO fields |
