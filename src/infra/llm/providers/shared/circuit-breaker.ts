 ...
 * @ai-summary Rate-limit errors skip the failure counter to prevent cascading outages — one quota signal cannot trip the breaker when the provider is healthy.
 */
