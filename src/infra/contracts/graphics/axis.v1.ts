...
export const AxisSpecV1Schema = z
  .object({
    ...
    // Ratio of x-unit pixel width to y-unit pixel width. `1` (default) keeps
    // grid squares square and unit circles circular; `2` makes x-units twice
    // as wide as y-units. Only meaningful for the graph block.
