...
--primary: 217 91% 60% /* Maps to #2d5af7 (primary actions) */ --success: 142 71% 45%
  /* Maps to #27ae60 (completed items) */ --warning: 38 92% 50% /* Maps to #f39c12 (warnings) */
  --destructive: 0 84.2% 60.2% /* Maps to #e74c3c (exams/errors) */ --accent: 271 91% 65%
  /* Maps to #9b59b6 (questions/ask mode) */ --background: 0 0% 100%
  /* Maps to #fcfdfe (light background) */ --foreground: 222.2 84% 4.9%
  /* Maps to #1a1a1a (dark text) */;
```
