...
Cycle 17 — healthy: 1, warn: 11, broken: 13 of 25 duties.

| Duty | Staff | Cadence | Verdict | Note |
|------|-------|---------|---------|------|
| approval-gate | cto | 15m | broken | state file never created; procedure references data.prs but can never persist it; will re-process same PRs every tick |
...
| publish-release | ceo | - (disabled) | warn | no kody-job-next-state block; disabled=true so idle by design |
