 ...
 *
 * @ai-summary Generates 1536-dimension vectors. Dimension is validated against a constant guardrail — mismatch throws rather than returning a wrong-sized vector to callers.
 *
 * @fileType service
 * @domain ai
 */
