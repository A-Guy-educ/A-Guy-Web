...
The job's agent runs `python3 .kody/executables/redispatch/tick.py` and
...
Reads/writes `.kody/duties/redispatch.state.json` (read only here — the
...
# --- constants ---
STATE_FILE = ".kody/duties/redispatch.state.json"
DRYRUN_LOG_CAP = 50
