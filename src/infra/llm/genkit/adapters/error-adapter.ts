 ...
 * @ai-summary Wraps Genkit errors in LLMError with message-pattern classification; rate-limit details preserved up to 400 chars for downstream retry logic
 *
