 ...
 * @ai-summary Shared agent definitions for Cody chat — single source of truth
 */
...
export interface AgentConfig {
   ...
   * - 'all': MCP + all custom Cody tools (dashboard manager)
...
- **Pipeline**: Cody CI/CD pipeline (GitHub Actions, opencode agents)
...
- \`src/ui/cody/\` — Cody dashboard components
