...
describe('orchestrator integration', () => {
  ...
  describe('pipeline stage integration', () => {
    it('defines correct stages for spec and impl pipelines', async () => {
      ...
      // Impl pipeline should have architect, plan-gap, parallel[test,build], review/fix cycle, and commit/verify/pr
      ...
      // 9 stages: architect, plan-gap, test, build, commit, review, fix, verify, pr
