...
### Features
- Auto-check single-select MCQ and inline exercise given-data (ae77cc626)
- Flip chat-view top row and thread mute through LessonMenu (bdcac98e6)
- Restructure chat-view top row per mockup corrections (edf0a1874)
- Redesign chat-view mode to floating-pill mockup (12a94658c)
- Restyle chat view to floating pill design on mobile (418809812)
- Gate per-block notebook on admin showNotebook opt-in (1f971d4b3)
- Notebook attached per question block; LessonMenu button hamburger-only (4df7142a5)
- Floating lesson menu replaces exercise header + tab bar (f2e32218c)
- Notebook v2 - reuse Ask-page canvas and wire check-solution to chat (54253e1dd)
- Read voice + rate from admin tts_settings global (8fb791af1)
- Handwritten notebook demo (client-side, interactive + chat views) (ce967aaa0)
- Use separate GOOGLE_TTS_API_KEY for Cloud Text-to-Speech (bdc6dd382)
- Switch Hebrew lesson narration to Google Cloud TTS (67bb39f74)
- Lesson view round 2 (fullscreen chrome, chat math input, LaTeX-aware checker) (acaadf274)
- Exercise view polish (svg scaling, tts, spacing, math color, data text) (5388a09c8)
- Full-bleed mobile exercise surface with floating nav (703c44031)
- Boss round 2 on header height, chat width, callouts, X overlap (4b5a593e8)
- Add scalable tutor chat core (8adc8f0be)
...
### Fixes
- Try every payload-token cookie so a stale variant doesn't lock users out (#1156) (6e780a522)
- De-dupe given-data render in chat view (9bb64676b)
- Restore gap utility mangled by design-token codemod (871fcd8c1)
- Lock QuestionNotebook on historical chat bubbles (7eff48c3d)
- Address review of notebook-per-block PR (chat-native gap, dead FAB, SVG note, label) (786f3c1ce)
- Revert pass-5 hasChatListener addition (was duplicating Notebook FAB) (5bb0416a7)
- Address review pass 5 (restore Notebook FAB in chat view + stable resize observer) (6edfc279e)
- Address review pass 4 findings (canvas resize, double-tap, tokens, aria, mount guard) (8d01013a7)
- Move LessonMenu to start-3 + inline SSR transform for Notebook aside (035e0b6f6)
- Address real-review findings (fix HIGH ask-page trap + MEDIUM notebook stroke loss) (ed928956b)
- Address lesson-menu review pass 1 (kill dead fullscreen, drop no-op ternary) (a34e67cc7)
- Address notebook v2 review pass 1 (dedupe upload, surface errors, tests) (39c6a0f2a)
- Bump admin settings fetch timeout to 8s for cold starts (94c30c635)
- Bound admin fetch with timeout + failure backoff (aff77313f)
- Allow data: media so base64 TTS audio plays (80cb2170f)
- Address notebook demo review pass 1 (i18n, pen tokens, tests) (b0b3ae6a4)
- Use he-IL-Wavenet-A (Neural2 not available for Hebrew) (acfd81237)
- Cover \leq / \geq / \neq in latex-plain matcher, word-boundary Greek letters (908375561)
- Address review findings on exercise view polish (df787fdcc)
- Kill horizontal overflow on mobile (5631ee09c)
- Apply low-severity review nits on callouts and mobile padding (e22b3b88b)
- Synchronize dependency lock configuration (b4d8ff8bd)
...
### Docs
- Add production content inventory report (9aa989d2b)

### Chores
- release v0.34.1 (d0592f2d9)
- add #1158 (6a43e83b1)
- add #1157 (631734aee)
- add #1156 (b77e09bc6)
- add #1154 (db2b3da01)
...
- add #1147 (305162b22)
- add #1148 (562b79059)
- Bump browserslist to patched 4.28.7+ (2c183b008)
- add #1145 (2eeb18417)
- add #1144 (b49afa468)
- add #1143 (1515122b8)
- add #1142 (83ee6a7ef)
...
- add #1120 (9e0e05299)
- add #1119 (b5bb57910)
- Drop dead honeypot form field from signup test helper (863f81a97)
- add #1118 (ad15bdf7d)
- add #1117 (1746221ee)
- add #1116 (91fa748c1)
- add #1115 (7ca2a774e)
...
### Other
- Update MCQ auto-submit test for new single-select behavior (2d6683e62)
- Undo chat sidebar pill restyle (a13c7ef6b)
- Fix failing scheduled workflows on dev (b657dd52f)
...
- feat(tts): Use separate GOOGLE_TTS_API_KEY for Cloud Text-to-Speech ([#1133](https://github.com/A-Guy-educ/A-Guy-Web/pull/1133)) — @aguyshayb
- feat(tts): Switch Hebrew lesson narration to Google Cloud TTS ([#1132](https://github.com/A-Guy-educ/A-Guy-Web/pull/1132)) — @aguyshayb
...
- chore: release v0.33.9 ([#1124](https://github.com/A-Guy-educ/A-Guy-Web/pull/1124)) — @aguyaharonyair
- promote: dev -> main (v0.33.8) ([#1123](https://github.com/A-Guy-educ/A-Guy-Web/pull/1123)) — @aguyaharonyair
...
- chore: release v0.33.6 ([#1115](https://github.com/A-Guy-educ/A-Guy-Web/pull/1115)) — @aguyaharonyair
