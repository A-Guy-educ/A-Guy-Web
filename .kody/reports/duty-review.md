...
Cycle 17 — 1 healthy, 7 warn, 18 broken of 26 duties.

| Duty | Staff | Cadence | Verdict | Note |
|------|-------|---------|---------|------|
| approval-gate | cto | 15m | broken | state file never created (0 commits to state path); cadence guard absent from procedure |
| architecture-audit | cto | 7d (disabled) | broken | script never implemented (404); body references deprecated .kody/jobs/ path; no kody-job-next-state block |
...
| coverage-floor | kody | 1d (disabled) | broken | script absent (404); cadence formula inconsistency (every: 1d vs +20h); no kody-job-next-state block |
...
| flaky-test-quarantine | kody | 1d (disabled) | warn | no kody-job-next-state block; disabled by design |
...
| publish-release | cto | manual (disabled) | warn | no kody-job-next-state block; disabled by design |
...
| security-audit | cto | 1d (disabled) | warn | no kody-job-next-state block; disabled by design |
...
| type-debt | kody | 7d (disabled) | warn | no kody-job-next-state block; state never created; disabled by design |