...
|------|-------|---------|---------|------|
| approval-gate | cto | 15m | healthy | kody-job-next-state block now present; design is sound; state never created indicates procedure may not be scheduled/running, but design passes every check |
...
| docs-code | docs | 7d | broken | no kody-job-next-state block; state never created |
