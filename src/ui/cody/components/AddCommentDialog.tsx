 ...
 * @ai-summary Dialog with markdown editor to add a simple comment on a PR (without @cody action)
 */
'use client'
    ...
    <Dialog open={isOpen} onOpenChange={(open) => !open && handleClose()}>
      <DialogContent className="max-w-lg">
        <DialogHeader>
          ...
          <DialogDescription>
            Write a comment. This will be posted directly on the PR (without triggering Cody).
          </DialogDescription>
        </DialogHeader>
