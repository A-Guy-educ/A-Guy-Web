...
describe('generateAssistantReply locale', () => {
  ...
  it('prepends Hebrew instruction when locale is he', async () => {
    ...
    await expect(generateAssistantReply({ message: 'שלום', locale: 'he' })).resolves.toBe(
      'תשובה בעברית',
    )
  ...
  it('does not prepend Hebrew instruction when locale is en', async () => {
    ...
    await expect(generateAssistantReply({ message: 'hello', locale: 'en' })).resolves.toBe('Hello')
  ...
  it('does not prepend Hebrew instruction when locale is undefined', async () => {
    ...
    await expect(generateAssistantReply({ message: 'hi' })).resolves.toBe('Hi')
