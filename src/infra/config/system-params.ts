...
export const SystemParams = {
   ...
   */
  async getPdfConversionMaxSegmentPages(tenantId?: string): Promise<number> {
   ...
   */
  async getPdfConversionMaxExercisesPerSegment(tenantId?: string): Promise<number> {
   ...
   */
  async getPdfConversionMaxPromptSizeBytes(tenantId?: string): Promise<number> {
