 ...
 * @ai-summary Adapts MCP tool definitions to Genkit's format. Genkit 1.x requires tool responses as Part objects (array of { text: string }), not raw strings — wrapToolExecutorForGenkit performs this conversion.
 */
