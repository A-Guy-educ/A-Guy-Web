...
describe('stage-prompts', () => {
  ...
  describe('STAGE_CONTEXT_FILES', () => {
    it('should map stages to their correct file lists (from registry)', () => {
      ...
      expect(STAGE_CONTEXT_FILES.build).toContain('spec.md')
      ...
      expect(STAGE_CONTEXT_FILES.review).toContain('review.md')
      expect(STAGE_CONTEXT_FILES.review).toContain('build.md')
      expect(STAGE_CONTEXT_FILES.review).toContain('spec.md')
      expect(STAGE_CONTEXT_FILES.fix).toContain('verify-failures.md')
      expect(STAGE_CONTEXT_FILES.fix).toContain('review.md')
      expect(STAGE_CONTEXT_FILES.fix).toContain('rerun-feedback.md')
    })
